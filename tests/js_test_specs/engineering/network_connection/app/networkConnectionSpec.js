describe("NetworkConnectionTestSuite", function() {
	describe("Testing Network Connection in Ruby via AJAX.  ", function() {
		...
		//  Global Properties
		var remoteHost = "http://192.168.0.4";	//  Address of ServerSideAssistant
